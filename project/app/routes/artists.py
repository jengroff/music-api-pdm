...
@router.get("/artists/{id}", response_model=Artist_Pydantic, responses={404: {"model": HTTPNotFoundError}})
...
@router.delete("/artists/{id}", response_model=Status, responses={404: {"model": HTTPNotFoundError}})
