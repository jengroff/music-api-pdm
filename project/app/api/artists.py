...
@router.get(
    "/artists",
    response_model=List[ArtistPydantic],
    summary="Get list of all artists in the database",
)
...
@router.put(
    ...
    response_model=ArtistPydantic,
    status_code=200,
    summary="Update a specific artist by id",
)
async def update_artist(artist: ArtistInPydantic, id: int = Path(..., gt=0)):
...
@router.delete(
    ...
    status_code=200,
    summary="Delete a specific artist by id",
)
